...
require(["domReady!", "jquery", "jquery-ui", "hue/hue", "hue/colors"], function(doc, $, ui, hue, colors) {
    'use strict';
    ...
    $('#allRed').on('click', function(e) {
        hue.setAllColors(colors.hexFullRed);
    });
    
    $('#allBlue').on('click', function(e) {
        hue.setAllColors(colors.hexFullBlue);
    });
    
    $('#allGreen').on('click', function(e) {
        hue.setAllColors(colors.hexFullGreen);
    });
    
    $('#allWhite').on('click', function(e) {
        hue.setAllColors(colors.hexFullWhite);
    });
